...
//Function describes the layout of the side bar

  const email = localStorage.getItem("email");
  const {t} = useTranslation('common');
  const sideItems = [
    {
      text: t('homepage.home'),
      logo: <FaHome />,
      path: "/dashboard",
    },
    {
      text: t('homepage.food'),
      logo: <FaListAlt />,
      path: "/dashboard/food",
    },
    {
      text: t('homepage.profile'),
      logo: <FaUser />,
          ...
          <Link to="/">
            <h1>
              <span style={{ color: "#000000", fontSize: "1.5rem" }}>
                PLATE<span style={{ color: "red", fontSize: "2rem" }} >SHARE</span>
              </span>
            </h1>
          </Link>
        </div>
